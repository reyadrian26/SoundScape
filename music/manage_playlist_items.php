		...
		<div class="row">
			<div class="form-group col-md-12">
				...
				<div class="position-relative w-100">
					<input type="search" class="form-control form-control-sm w-100" id="msearch" placeholder="Enter music title or artist" autocomplete="off" style="font-family: 'Poppins';">
...
<div id="list_clone" class="d-none">
	...
	<div id="pdet" class="d-flex justify-content-between align-items-center">
		<div class="d-flex" style="font-family: 'Poppins'!important;">
