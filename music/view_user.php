...
if(isset($_GET['id'])){
	...
	$qry = $conn->query("SELECT *, concat(firstname, ' ', lastname) as name, subscriptions.name as subscription_name FROM users LEFT JOIN subscriptions ON users.subscription_id = subscriptions.id WHERE users.id = ".$_GET['id'])->fetch_array();
	foreach($qry as $k => $v){
		$$k = $v;
	}
}
		...
		<div class="card-footer">
			<div class="container-fluid">
				...
				<dl>
					...
					<dd><?php echo $subscription_name ?></dd>
				</dl>
