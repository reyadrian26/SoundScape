...
<div class="col-lg-12">
  <div class="card card-outline card-primary" style="background-color: #222225 !important; color: white; border-top: #222225 1px solid;">
    <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group text-dark">
              <label for="" class="control-label" style="color: white;">Genre</label>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control form-control-sm" name="title" placeholder="Enter title" value="<?php echo isset($mtitle) ? $mtitle : '' ?>" required>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Artist</label>
              <input type="text" class="form-control form-control-sm" name="artist" placeholder="Enter artist" value="<?php echo isset($artist) ? $artist : '' ?>">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-10">
            <div class="form-group">
              ...
              <textarea name="description" id="" cols="30" rows="4" placeholder="Enter description" class="summernote form-control"><?php echo isset($description) ? $description : '' ?></textarea>
            </div>
          </div>
        </div>
        <div class="row">
    ...
    <div class="card-footer border-top border-info" style="border-color: #f48c24 !important">
      <div class="d-flex w-100 justify-content-center align-items-center">
        <button class="btn btn-flat mx-2" form="manage-music" style="background-color: #f98f1d; color: white;">Save</button>
...
$(document).ready(function(){
  // Retrieve the value of the 'mtitle' variable
  var mtitle = "<?php echo isset($mtitle) ? addslashes($mtitle) : ''; ?>";

  // Set the value of the Title input field
  $('input[name="title"]').val(mtitle);
});
